...
val LightCalClonerColors = CalClonerColors(
    isDark = false,
    accent = Palette.Mint600,
    onAccent = Palette.White,
    accentSubtle = Palette.Mint500.copy(alpha = 0.12f),
    accentBorder = Palette.Mint600.copy(alpha = 0.35f),

    success = Palette.Mint600,
    onSuccess = Palette.White,
    successSubtle = Palette.Mint500.copy(alpha = 0.10f),
    successBorder = Palette.Mint600.copy(alpha = 0.30f),

    warning = Palette.Amber600,
    onWarning = Palette.White,
    warningSubtle = Palette.Amber500.copy(alpha = 0.15f),
    warningBorder = Palette.Amber600.copy(alpha = 0.40f),

    danger = Palette.Rose600,
    onDanger = Palette.White,
    dangerSubtle = Palette.Rose500.copy(alpha = 0.12f),
    dangerBorder = Palette.Rose600.copy(alpha = 0.35f),

    background = Palette.Zinc50,
    surfaceCard = Palette.White,
    surfaceElevated = Palette.Zinc100,
    borderSubtle = Palette.Zinc200,
    borderProminent = Palette.Zinc400,

    textPrimary = Palette.Zinc950,
